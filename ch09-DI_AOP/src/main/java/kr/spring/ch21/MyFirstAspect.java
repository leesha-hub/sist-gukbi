...
public class MyFirstAspect {
	 ...
	 * 종류						설명
	 * Before Advice			대상 객체의 메서드 호출 전에 공통 기능을 실행 @Before
	 * After Returning Advice	대상 객체의 메서드가 예외 없이 실행한 이후에
	 * 					        공통 기능을 실행 @AfterReturning 
	 * After Throwing Advice	대상 객체의 메서드
	 * 							를 실행하는 도중 예외가 
	 *                          발생한 경우에 공통 기능을 실행 @AfterThrowing 
	 * After Advice				대상 객체의 메서드를 실행하는 도중 예외가
	 *                          발생했는지의 여부와 상관없이 메서드 실행 후
	 *                          공통 기능을 실행(try~catch~finally의 
	 *                          finally 블럭과 비슷) @After                                                  
	 * Around Advice			대상 객체의 메서드 실행 전, 후 또는 예외
	 *                          발생 시점에 공통 기능을 실행하는데 사용 @Around
	 */
