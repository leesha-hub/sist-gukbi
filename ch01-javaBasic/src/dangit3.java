...
class Solution {
	public int[] solution(int[][] scores) {
        ...
        int questionSum1 = 0;
        int questionSum2 = 0;
        for(int[] question : scores) {
        	System.out.println("1번 문제 : " + question[0]);
        	System.out.println("2번 문제 : " + question[1]);
        	System.out.println("=========================");
        	scores[i][2] = question[0] + question[1];
        	questionSum1 += question[0];
        	questionSum2 += question[1];
        	i++;
        }
